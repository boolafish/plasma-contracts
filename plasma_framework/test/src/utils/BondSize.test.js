...
contract('BondSize', () => {
    ...
    describe('buildParams', () => {
        it('should fail when setting initialBondSize to 0', async () => {
            const initialBondSize = new BN(0);
            const lowerBoundDivisor = 2;
            const upperBoundMultiplier = 3;

            // BondSizeMock constructor would call buildParams under the hood
            await expectRevert(
                BondSizeMock.new(
                    initialBondSize,
                    lowerBoundDivisor,
                ...
                'initialBondSize cannot be 0',
            );
        });

        it('should fail when setting lowerBoundDivisor to 0', async () => {
            const initialBondSize = new BN(20000000000);
            const lowerBoundDivisor = 0;
            const upperBoundMultiplier = 3;
            ...
            await expectRevert(
                ...
                'lowerBoundDivisor cannot be 0',
            );
        });

        it('should fail when setting upperBoundMultiplier to 0', async () => {
            const initialBondSize = new BN(20000000000);
            const lowerBoundDivisor = 2;
            const upperBoundMultiplier = 0;
            ...
            await expectRevert(
                ...
                'upperBoundMultiplier cannot be 0',
            );
        });
    });
    ...
    describe('updateBondSize', () => {
        ...
        describe('with boundary size of numbers', () => {
            ...
            it('should able to update to 1', async () => {
